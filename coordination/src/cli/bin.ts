 ...
 */
function parseEnvironment(envArg?: string): Environment {
 ...
 */
function parseTestType(typeArg?: string): TestType {
 ...
 */
function parseDeploymentTarget(targetArg?: string): DeploymentTarget {
  if (!targetArg) {
